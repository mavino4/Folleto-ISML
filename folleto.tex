	...
	\shortstack[r]{
		...
		\parbox{8.5in}{%
			...
			\begin{itemize}%
					...
					\hspace*{1.65in}\includegraphics[scale=0.060]{images/QR_Code_Grupo_La_Paz_School_of_AI}
					\item \textbf{Formulario de Registro:} %\url{https://goo.gl/zHyjiJ}\\
					\rurl{bit.ly/RegistroISML}\\
					\hspace*{1.65in}\includegraphics[scale=0.060]{images/QR_Code_Formulario}
			\end{itemize}%
		}%
		\\
...
\parbox{8.5in}{
\begin{center}
\includegraphics[scale=0.08]{images/ESTADISTICA.PNG}
\hspace{3.5 cm}
\includegraphics[scale=0.09]{images/CEFAC.PNG}
\hspace{4 cm}
\includegraphics[scale=0.28]{images/INFORMATICA.PNG}
\end{center}
}
}}}
\end{document}
